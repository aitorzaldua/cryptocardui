      ...
      <div className="flex mf:flex-row flex-col items-start justify-center md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
            ...
            <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
              Connect your wallet, select the cryprocurrency in your wallet and send crypto in seconds.
            </p>
            {!currentAccount && (
                <button
                type="button"
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
              ...
              <div className={`sm:rounded-tr-2xl ${companyCommonStyles}`}>Multichain</div>
